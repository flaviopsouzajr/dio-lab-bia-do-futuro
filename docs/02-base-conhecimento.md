...
| `produtos_financeiros.json` | JSON | Conhecer os produtos financeiros disponíveis para que eles possam ser ensinados ao cliente. |
...
O produto Fundo Imobiliário (FII) substituiu o Fundo Multimercado, pois pessoalmente me sinto mais confiante em usar apenas produtos financeiros que eu conheço. Assim, poderei validar as respostas do José Finas de forma mais assertiva.
...
Para simplificar, podemos simplesmente "injetar" os dados em nosso prompt, garantindo que o Agente tenha o melhor contexto possível. Lembrando que, em soluções mais robustas, o ideal é que essas informações sejam carregadas dinamicamente para que possamos ganha flexibilidade.
...
HISTORICO E ATENDIMENTO (data/historico_atendimento.csv):
